      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        {reviews.map((review) => (
          ...
          >
            ...
            />
            <div className="p-4">
              <h3 className="text-xl font-semibold text-gray-800">{review.restaurantName}</h3>
              {/* Optional: Add more info like short description or user */}
              {/* <p className="text-gray-600 mt-1">{review.review.slice(0, 50)}...</p> */}
            </div>
          </Link>
        ))}
      </div>
